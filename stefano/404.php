			...
			<div id="content" role="main">
				...
				<article id="post-0" class="post error404 not-found">
					<header class="entry-header">
						...
						<div class="center" style="margin: 40px;"><img align="middle" vspace="40px" src="<?php echo('/grafica/404/computer-monkey-404.gif');?>"></div>
						<h2 class="center"><?php _e( 'We have already sent a team of qualified and highly trained monkeys to solve the problem.', 'tiga' ); ?></h2>
						<div class="center" style="margin: 40px;"><img align="middle" vspace="40px" src="<?php echo('/grafica/404/computer-monkey-404.png');?>"></div>
					</header>
